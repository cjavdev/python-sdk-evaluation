...
from samsara.types.fleet import EquipmentListResponse
...
class TestEquipment:
    ...
    def test_method_list(self, client: Samsara) -> None:
        equipment = client.fleet.equipment.list()
    ...
    def test_raw_response_list(self, client: Samsara) -> None:
        response = client.fleet.equipment.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Samsara) -> None:
        with client.fleet.equipment.with_streaming_response.list() as response:
...
class TestAsyncEquipment:
    ...
    async def test_method_list(self, async_client: AsyncSamsara) -> None:
        equipment = await async_client.fleet.equipment.list()
        assert_matches_type(EquipmentListResponse, equipment, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncSamsara) -> None:
        response = await async_client.fleet.equipment.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncSamsara) -> None:
        async with async_client.fleet.equipment.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

...
class TestHistory:
    ...
    def test_method_list(self, client: Samsara) -> None:
        history = client.fleet.drivers.tachograph_files.history.list(
            end_time="endTime",
    ...
    def test_raw_response_list(self, client: Samsara) -> None:
        response = client.fleet.drivers.tachograph_files.history.with_raw_response.list(
            end_time="endTime",
            start_time="startTime",
        )
    ...
    def test_streaming_response_list(self, client: Samsara) -> None:
        with client.fleet.drivers.tachograph_files.history.with_streaming_response.list(
            end_time="endTime",
            start_time="startTime",
        ) as response:
...
class TestAsyncHistory:
    ...
    async def test_method_list(self, async_client: AsyncSamsara) -> None:
        history = await async_client.fleet.drivers.tachograph_files.history.list(
            end_time="endTime",
            start_time="startTime",
        )
        assert_matches_type(HistoryListResponse, history, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncSamsara) -> None:
        response = await async_client.fleet.drivers.tachograph_files.history.with_raw_response.list(
            end_time="endTime",
            start_time="startTime",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncSamsara) -> None:
        async with async_client.fleet.drivers.tachograph_files.history.with_streaming_response.list(
            end_time="endTime",
            start_time="startTime",
        ) as response:
            assert not response.is_closed

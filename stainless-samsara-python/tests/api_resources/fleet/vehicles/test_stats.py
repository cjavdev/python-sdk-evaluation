...
from samsara.types.fleet.vehicles import VehicleStatsListResponse
...
class TestStats:
    ...
    def test_method_feed(self, client: Samsara) -> None:
        stat = client.fleet.vehicles.stats.feed(
            types=["ambientAirTemperatureMilliC"],
        )
        assert_matches_type(VehicleStatsListResponse, stat, path=["response"])
    ...
    def test_method_feed_with_all_params(self, client: Samsara) -> None:
        stat = client.fleet.vehicles.stats.feed(
            types=["ambientAirTemperatureMilliC"],
            after="after",
            decorations=["ambientAirTemperatureMilliC"],
    ...
    def test_raw_response_feed(self, client: Samsara) -> None:
        response = client.fleet.vehicles.stats.with_raw_response.feed(
            types=["ambientAirTemperatureMilliC"],
        )
    ...
    def test_streaming_response_feed(self, client: Samsara) -> None:
        with client.fleet.vehicles.stats.with_streaming_response.feed(
            types=["ambientAirTemperatureMilliC"],
        ) as response:
    ...
    def test_method_history(self, client: Samsara) -> None:
        stat = client.fleet.vehicles.stats.history(
            end_time="endTime",
    ...
    def test_raw_response_history(self, client: Samsara) -> None:
        response = client.fleet.vehicles.stats.with_raw_response.history(
            end_time="endTime",
            start_time="startTime",
            types=["ambientAirTemperatureMilliC"],
        )
    ...
    def test_streaming_response_history(self, client: Samsara) -> None:
        with client.fleet.vehicles.stats.with_streaming_response.history(
            end_time="endTime",
            start_time="startTime",
            types=["ambientAirTemperatureMilliC"],
        ) as response:
...
class TestAsyncStats:
    ...
    async def test_method_feed(self, async_client: AsyncSamsara) -> None:
        stat = await async_client.fleet.vehicles.stats.feed(
            types=["ambientAirTemperatureMilliC"],
        )
        assert_matches_type(VehicleStatsListResponse, stat, path=["response"])
    ...
    async def test_raw_response_feed(self, async_client: AsyncSamsara) -> None:
        response = await async_client.fleet.vehicles.stats.with_raw_response.feed(
            types=["ambientAirTemperatureMilliC"],
        )
    ...
    async def test_streaming_response_feed(self, async_client: AsyncSamsara) -> None:
        async with async_client.fleet.vehicles.stats.with_streaming_response.feed(
            types=["ambientAirTemperatureMilliC"],
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_history(self, async_client: AsyncSamsara) -> None:
        stat = await async_client.fleet.vehicles.stats.history(
            end_time="endTime",
            start_time="startTime",
            types=["ambientAirTemperatureMilliC"],
        )
    ...
    async def test_raw_response_history(self, async_client: AsyncSamsara) -> None:
        response = await async_client.fleet.vehicles.stats.with_raw_response.history(
            end_time="endTime",
            start_time="startTime",
            types=["ambientAirTemperatureMilliC"],
        )
    ...
    async def test_streaming_response_history(self, async_client: AsyncSamsara) -> None:
        async with async_client.fleet.vehicles.stats.with_streaming_response.history(
            end_time="endTime",
            start_time="startTime",
            types=["ambientAirTemperatureMilliC"],
        ) as response:

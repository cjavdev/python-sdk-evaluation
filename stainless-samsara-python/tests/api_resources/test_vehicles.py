...
from samsara.types.fleet import VehiclesListVehiclesResponseBody
...
class TestVehicles:
    ...
    def test_method_list(self, client: Samsara) -> None:
        vehicle = client.vehicles.list()
        assert_matches_type(VehiclesListVehiclesResponseBody, vehicle, path=["response"])
    ...
    def test_streaming_response_list(self, client: Samsara) -> None:
        with client.vehicles.with_streaming_response.list() as response:
...
class TestAsyncVehicles:
    ...
    async def test_method_list(self, async_client: AsyncSamsara) -> None:
        vehicle = await async_client.vehicles.list()
        assert_matches_type(VehiclesListVehiclesResponseBody, vehicle, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncSamsara) -> None:
        response = await async_client.vehicles.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncSamsara) -> None:
        async with async_client.vehicles.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

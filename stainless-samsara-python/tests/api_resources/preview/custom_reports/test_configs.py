...
class TestConfigs:
    ...
    def test_method_list(self, client: Samsara) -> None:
        config = client.preview.custom_reports.configs.list()
        assert_matches_type(CustomReportsGetCustomReportConfigsResponseBody, config, path=["response"])
    ...
    def test_raw_response_list(self, client: Samsara) -> None:
        response = client.preview.custom_reports.configs.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Samsara) -> None:
        with client.preview.custom_reports.configs.with_streaming_response.list() as response:
...
class TestAsyncConfigs:
    ...
    async def test_method_list(self, async_client: AsyncSamsara) -> None:
        config = await async_client.preview.custom_reports.configs.list()
        assert_matches_type(CustomReportsGetCustomReportConfigsResponseBody, config, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncSamsara) -> None:
        response = await async_client.preview.custom_reports.configs.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncSamsara) -> None:
        async with async_client.preview.custom_reports.configs.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

...
class TestData:
    ...
    def test_method_retrieve(self, client: Samsara) -> None:
        data = client.preview.custom_reports.runs.data.retrieve()
        assert_matches_type(CustomReportsGetCustomReportRunDataResponseBody, data, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: Samsara) -> None:
        response = client.preview.custom_reports.runs.data.with_raw_response.retrieve()
    ...
    def test_streaming_response_retrieve(self, client: Samsara) -> None:
        with client.preview.custom_reports.runs.data.with_streaming_response.retrieve() as response:
...
class TestAsyncData:
    ...
    async def test_method_retrieve(self, async_client: AsyncSamsara) -> None:
        data = await async_client.preview.custom_reports.runs.data.retrieve()
        assert_matches_type(CustomReportsGetCustomReportRunDataResponseBody, data, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncSamsara) -> None:
        response = await async_client.preview.custom_reports.runs.data.with_raw_response.retrieve()
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncSamsara) -> None:
        async with async_client.preview.custom_reports.runs.data.with_streaming_response.retrieve() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

...
__all__ = ["AttributeCreateParams", "Entity"]


class AttributeCreateParams(TypedDict, total=False):
    attribute_type: Required[Annotated[Literal["string", "number"], PropertyInfo(alias="attributeType")]]
    """Denotes the data type of the attribute's values.

    Valid values: `string`, `number`.
    """

    attribute_value_quantity: Required[
        Annotated[Literal["single", "multi"], PropertyInfo(alias="attributeValueQuantity")]
    ]
    """

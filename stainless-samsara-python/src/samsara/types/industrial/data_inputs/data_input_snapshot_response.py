...
class Data(BaseModel):
    ...
    fft_spectra_point: Optional[DataFftSpectraPoint] = FieldInfo(alias="fftSpectraPoint", default=None)
    """FFT spectrum data point of a data input."""

    j1939_d1_status_point: Optional[DataJ1939D1StatusPoint] = FieldInfo(alias="j1939D1StatusPoint", default=None)
    """Active J1939D1 statuses of a device."""

    location_point: Optional[DataLocationPoint] = FieldInfo(alias="locationPoint", default=None)
    """A single location data point of a data input."""

    name: Optional[str] = None
    """Name of this data input."""

    number_point: Optional[DataNumberPoint] = FieldInfo(alias="numberPoint", default=None)
    """A single numeric data point of a data input."""

    string_point: Optional[DataStringPoint] = FieldInfo(alias="stringPoint", default=None)
...
class DataInputSnapshotResponse(BaseModel):
    ...
    """An array of data inputs' latest data points.

    Each object in the array represents a data input and its most recent data point.
    """

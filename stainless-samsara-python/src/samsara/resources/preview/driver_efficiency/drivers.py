...
from ....types.preview.driver_efficiency import driver_list_params
from ....types.preview.driver_efficiency.driver_efficiency_get_driver_efficiency_by_drivers_response_body import (
...
class DriversResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        your organization and grouped by drivers based on the time parameters passed in.
        ...
        return self._get(
            ...
            cast_to=DriverEfficiencyGetDriverEfficiencyByDriversResponseBody,
        )

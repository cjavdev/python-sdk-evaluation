...
class TestLogs:
    ...
    def test_raw_response_list(self, client: Samsara) -> None:
        response = client.hos.logs.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: Samsara) -> None:
        with client.hos.logs.with_streaming_response.list() as response:
...
class TestAsyncLogs:
    ...
    async def test_method_list(self, async_client: AsyncSamsara) -> None:
        log = await async_client.hos.logs.list()
        assert_matches_type(LogListResponse, log, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncSamsara) -> None:
        response = await async_client.hos.logs.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncSamsara) -> None:
        async with async_client.hos.logs.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"

...
class TestVehicles:
    ...
    def test_method_list(self, client: Samsara) -> None:
        vehicle = client.preview.driver_efficiency.vehicles.list(
            end_time="endTime",
            start_time="startTime",
        )
        assert_matches_type(DriverEfficiencyGetDriverEfficiencyByVehiclesResponseBody, vehicle, path=["response"])
    ...
    def test_raw_response_list(self, client: Samsara) -> None:
        response = client.preview.driver_efficiency.vehicles.with_raw_response.list(
            end_time="endTime",
            start_time="startTime",
        )
    ...
    def test_streaming_response_list(self, client: Samsara) -> None:
        with client.preview.driver_efficiency.vehicles.with_streaming_response.list(
            end_time="endTime",
            start_time="startTime",
        ) as response:
...
class TestAsyncVehicles:
    ...
    async def test_method_list(self, async_client: AsyncSamsara) -> None:
        vehicle = await async_client.preview.driver_efficiency.vehicles.list(
            end_time="endTime",
            start_time="startTime",
        )
        assert_matches_type(DriverEfficiencyGetDriverEfficiencyByVehiclesResponseBody, vehicle, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncSamsara) -> None:
        response = await async_client.preview.driver_efficiency.vehicles.with_raw_response.list(
            end_time="endTime",
            start_time="startTime",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncSamsara) -> None:
        async with async_client.preview.driver_efficiency.vehicles.with_streaming_response.list(
            end_time="endTime",
            start_time="startTime",
        ) as response:
            assert not response.is_closed

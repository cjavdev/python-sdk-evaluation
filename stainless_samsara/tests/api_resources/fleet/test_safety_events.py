...
class TestSafetyEvents:
    ...
    def test_method_list(self, client: Samsara) -> None:
        safety_event = client.fleet.safety_events.list(
            end_time="endTime",
            start_time="startTime",
        )
        assert_matches_type(SafetyEventsListResponse, safety_event, path=["response"])
    ...
    def test_raw_response_list(self, client: Samsara) -> None:
        response = client.fleet.safety_events.with_raw_response.list(
            end_time="endTime",
            start_time="startTime",
        )
        ...
        safety_event = response.parse()
        assert_matches_type(SafetyEventsListResponse, safety_event, path=["response"])

    @parametrize
    def test_streaming_response_list(self, client: Samsara) -> None:
        with client.fleet.safety_events.with_streaming_response.list(
            end_time="endTime",
            start_time="startTime",
        ) as response:
...
class TestAsyncSafetyEvents:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @parametrize
    async def test_method_list(self, async_client: AsyncSamsara) -> None:
        safety_event = await async_client.fleet.safety_events.list(
            end_time="endTime",
            start_time="startTime",
        )
        assert_matches_type(SafetyEventsListResponse, safety_event, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncSamsara) -> None:
        response = await async_client.fleet.safety_events.with_raw_response.list(
            end_time="endTime",
            start_time="startTime",
        )
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        safety_event = await response.parse()
        assert_matches_type(SafetyEventsListResponse, safety_event, path=["response"])

    @parametrize
    async def test_streaming_response_list(self, async_client: AsyncSamsara) -> None:
        async with async_client.fleet.safety_events.with_streaming_response.list(
            end_time="endTime",
            start_time="startTime",
        ) as response:
            assert not response.is_closed

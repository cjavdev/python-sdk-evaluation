...
from samsara import Samsara, AsyncSamsara, APIResponseValidationError
from samsara._types import Omit
from samsara._models import BaseModel, FinalRequestOptions
from samsara._constants import RAW_RESPONSE_HEADER
from samsara._exceptions import SamsaraError, APIStatusError, APITimeoutError, APIResponseValidationError
from samsara._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Samsara | AsyncSamsara) -> int:
...
class TestSamsara:
    client = Samsara(base_url=base_url, access_token=access_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "samsara/_legacy_response.py",
                        "samsara/_response.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(SamsaraError):
            with update_env(**{"ACCESS_TOKEN": Omit()}):
                client2 = Samsara(base_url=base_url, access_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Samsara) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(SAMSARA_BASE_URL="http://localhost:5000/from/env"):
            client = Samsara(access_token=access_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(SAMSARA_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                Samsara(access_token=access_token, _strict_response_validation=True, environment="production")

            client = Samsara(
                base_url=None, access_token=access_token, _strict_response_validation=True, environment="production"
            )
            assert str(client.base_url).startswith("https://api.samsara.com/")
    ...
    def test_base_url_trailing_slash(self, client: Samsara) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Samsara) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Samsara) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Samsara(base_url=base_url, access_token=access_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Samsara(base_url=base_url, access_token=access_token, _strict_response_validation=False)
    ...
    @mock.patch("samsara._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/addresses").mock(side_effect=httpx.TimeoutException("Test timeout error"))
        ...
        with pytest.raises(APITimeoutError):
            self.client.post(
                ...
                body=cast(
                    object,
                    dict(formatted_address="350 Rhode Island St, San Francisco, CA", geofence={}, name="Samsara HQ"),
                ),
    ...
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        respx_mock.post("/addresses").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/addresses").mock(side_effect=retry_handler)

        response = client.addresses.with_raw_response.create(
            formatted_address="350 Rhode Island St, San Francisco, CA", geofence={}, name="Samsara HQ"
        )
    ...
    def test_omit_retry_count_header(
        self, client: Samsara, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncSamsara:
    client = AsyncSamsara(base_url=base_url, access_token=access_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(SamsaraError):
            with update_env(**{"ACCESS_TOKEN": Omit()}):
                client2 = AsyncSamsara(base_url=base_url, access_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncSamsara) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(SAMSARA_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncSamsara(access_token=access_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

        # explicit environment arg requires explicitness
        with update_env(SAMSARA_BASE_URL="http://localhost:5000/from/env"):
            with pytest.raises(ValueError, match=r"you must pass base_url=None"):
                AsyncSamsara(access_token=access_token, _strict_response_validation=True, environment="production")
    ...
    def test_base_url_trailing_slash(self, client: AsyncSamsara) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncSamsara) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncSamsara) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncSamsara(base_url=base_url, access_token=access_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncSamsara(base_url=base_url, access_token=access_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.addresses.with_raw_response.create(
            formatted_address="350 Rhode Island St, San Francisco, CA", geofence={}, name="Samsara HQ"
        )
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncSamsara, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from samsara._utils import asyncify
        from samsara._base_client import get_platform 

...
from ....types.fleet.defects import history_list_params
from ....types.fleet.defects.history_list_response import HistoryListResponse
...
class HistoryResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        """
        Returns a list of DVIR defects in an organization, filtered by creation time.
        The maximum time period you can query for is 30 days.
        ...
        **Submit Feedback**: Likes, dislikes, and API feature requests should be filed
        ...
        Args:
          end_time: An end time in RFC 3339 format. Millisecond precision and timezones are
              ...
              2015-09-15T14:00:12-04:00). _The maximum time period you can query for is 30
              days._
          ...
          is_resolved: A filter on the data based on resolution status. Example: `isResolved=true`

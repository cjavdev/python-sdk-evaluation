...
__all__ = ["V1DriverSafetyScoreResponse", "HarshEvent"]
...
class V1DriverSafetyScoreResponse(BaseModel):
    ...
    """The driver’s Safety Score for the requested period.

    Note that if the driver has zero drive time in this period, the Safety Score

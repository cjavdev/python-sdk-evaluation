...
__all__ = ["DriverVehicleAssignmentUpdateParams", "Metadata"]


class DriverVehicleAssignmentUpdateParams(TypedDict, total=False):
    ...
    To make this an ongoing assignment (ie. an assignment with no end time), provide
    an endTime value of 'null'. Millisecond precision and timezones are supported.

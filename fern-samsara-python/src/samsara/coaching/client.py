...
class AsyncCoachingClient:
    ...
    async def get_driver_assignment(
        ...
        *,
        ...
        async def main() -> None:
            await client.coaching.get_driver_assignment()
    ...
    async def put_driver_assignment(
        self,
        *,
        driver_id: str,
        coach_id: typing.Optional[str] = None,
        ...
        async def main() -> None:
            await client.coaching.put_driver_assignment(
                driver_id="driverId",
            )
    ...
    async def get_sessions(
        ...
        *,
        ...
        async def main() -> None:
            await client.coaching.get_sessions(
                start_time=datetime.datetime.fromisoformat(
                    "2024-01-15 09:30:00+00:00",
                ),
            )

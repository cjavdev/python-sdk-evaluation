...
class SettingsGetDriverAppSettingsBadRequestErrorResponseBodyTypedDict(TypedDict):
...
class SettingsGetDriverAppSettingsBadRequestErrorResponseBody(BaseModel):
    r"""Bad Request parameters"""

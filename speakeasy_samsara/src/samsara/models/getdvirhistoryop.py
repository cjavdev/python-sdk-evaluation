...
class GetDvirHistoryRequestTypedDict(TypedDict):
    start_time: str
...
class GetDvirHistoryRequest(BaseModel):
...
GetDvirHistoryResponseTypedDict = TypeAliasType(
    "GetDvirHistoryResponseTypedDict",
    Union[DvirsListResponseTypedDict, StandardErrorResponseTypedDict],
)


GetDvirHistoryResponse = TypeAliasType(
    "GetDvirHistoryResponse", Union[DvirsListResponse, StandardErrorResponse]
)

...
ListAddressesResponse1TypedDict = TypeAliasType(
    "ListAddressesResponse1TypedDict",
    Union[ListAddressesResponseTypedDict, StandardErrorResponseTypedDict],
)


ListAddressesResponse1 = TypeAliasType(
    "ListAddressesResponse1", Union[ListAddressesResponse, StandardErrorResponse]
)

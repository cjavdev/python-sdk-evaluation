...
class GetEquipmentLocationsRequestTypedDict(TypedDict):
...
class GetEquipmentLocationsRequest(BaseModel):
    after: Annotated[
        Optional[str],
...
GetEquipmentLocationsResponseTypedDict = TypeAliasType(
    "GetEquipmentLocationsResponseTypedDict",
    Union[EquipmentLocationsResponseTypedDict, StandardErrorResponseTypedDict],
)


GetEquipmentLocationsResponse = TypeAliasType(
    "GetEquipmentLocationsResponse",
    Union[EquipmentLocationsResponse, StandardErrorResponse],
)

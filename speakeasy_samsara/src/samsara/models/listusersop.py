...
ListUsersResponse1TypedDict = TypeAliasType(
    "ListUsersResponse1TypedDict",
    Union[ListUsersResponseTypedDict, StandardErrorResponseTypedDict],
)


ListUsersResponse1 = TypeAliasType(
    "ListUsersResponse1", Union[ListUsersResponse, StandardErrorResponse]
)

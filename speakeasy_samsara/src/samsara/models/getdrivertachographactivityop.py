...
class GetDriverTachographActivityRequestTypedDict(TypedDict):
    start_time: str
    ...
    end_time: str
    r"""An end time in RFC 3339 format. It can't be more than 30 days past startTime. Millisecond precision and timezones are supported. (Examples: 2019-06-13T19:08:25Z, 2019-06-13T19:08:25.455Z, OR 2015-09-15T14:00:12-04:00)."""
...
class GetDriverTachographActivityRequest(BaseModel):
...
GetDriverTachographActivityResponseTypedDict = TypeAliasType(
    "GetDriverTachographActivityResponseTypedDict",
    Union[DriverTachographActivityResponseTypedDict, StandardErrorResponseTypedDict],
)


GetDriverTachographActivityResponse = TypeAliasType(
    "GetDriverTachographActivityResponse",
    Union[DriverTachographActivityResponse, StandardErrorResponse],
)

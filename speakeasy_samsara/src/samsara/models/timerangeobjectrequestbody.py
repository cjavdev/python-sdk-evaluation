...
class TimeRangeObjectRequestBodyDaysOfWeek(str, Enum):
...
class TimeRangeObjectRequestBodyTypedDict(TypedDict):
    ...
    days_of_week: List[TimeRangeObjectRequestBodyDaysOfWeek]
...
class TimeRangeObjectRequestBody(BaseModel):
    r"""A daily time range. If start time of day is greater than end time of day, then the time range applies overnight from the specified day of week into the following day."""

    days_of_week: Annotated[
        List[TimeRangeObjectRequestBodyDaysOfWeek], pydantic.Field(alias="daysOfWeek")
    ]
    r"""Which days this timezone applies to."""

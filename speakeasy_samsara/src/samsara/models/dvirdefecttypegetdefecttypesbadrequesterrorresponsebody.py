...
class DvirDefectTypeGetDefectTypesBadRequestErrorResponseBodyTypedDict(TypedDict):
...
class DvirDefectTypeGetDefectTypesBadRequestErrorResponseBody(BaseModel):
    r"""Bad Request parameters"""

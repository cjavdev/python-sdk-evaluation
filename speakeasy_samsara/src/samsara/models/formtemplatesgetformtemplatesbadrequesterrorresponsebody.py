...
class FormTemplatesGetFormTemplatesBadRequestErrorResponseBodyTypedDict(TypedDict):
...
class FormTemplatesGetFormTemplatesBadRequestErrorResponseBody(BaseModel):
    r"""Bad Request parameters"""

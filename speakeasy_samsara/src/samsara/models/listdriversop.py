...
class ListDriversQueryParamDriverActivationStatus(str, Enum):
...
class ListDriversRequestTypedDict(TypedDict):
    driver_activation_status: NotRequired[ListDriversQueryParamDriverActivationStatus]
    r"""If value is `deactivated`, only drivers that are deactivated will appear in the response. This parameter will default to `active` if not provided (fetching only active drivers)."""
...
class ListDriversRequest(BaseModel):
    driver_activation_status: Annotated[
        Optional[ListDriversQueryParamDriverActivationStatus],
...
ListDriversResponse1TypedDict = TypeAliasType(
    "ListDriversResponse1TypedDict",
    Union[ListDriversResponseTypedDict, StandardErrorResponseTypedDict],
)


ListDriversResponse1 = TypeAliasType(
    "ListDriversResponse1", Union[ListDriversResponse, StandardErrorResponse]
)

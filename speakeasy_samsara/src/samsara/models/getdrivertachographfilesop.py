...
class GetDriverTachographFilesRequestTypedDict(TypedDict):
    start_time: str
...
class GetDriverTachographFilesRequest(BaseModel):
...
GetDriverTachographFilesResponseTypedDict = TypeAliasType(
    "GetDriverTachographFilesResponseTypedDict",
    Union[TachographDriverFilesResponseTypedDict, StandardErrorResponseTypedDict],
)


GetDriverTachographFilesResponse = TypeAliasType(
    "GetDriverTachographFilesResponse",
    Union[TachographDriverFilesResponse, StandardErrorResponse],
)

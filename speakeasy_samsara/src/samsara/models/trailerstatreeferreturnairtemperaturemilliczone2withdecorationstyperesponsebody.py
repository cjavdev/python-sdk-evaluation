...
class TrailerStatReeferReturnAirTemperatureMilliCZone2WithDecorationsTypeResponseBodyTypedDict(
    TypedDict
):
...
class TrailerStatReeferReturnAirTemperatureMilliCZone2WithDecorationsTypeResponseBody(
    BaseModel
):
    r"""Return air temperature of zone 2 of the reefer. This is the temperature of the air as it enters the cooling unit."""

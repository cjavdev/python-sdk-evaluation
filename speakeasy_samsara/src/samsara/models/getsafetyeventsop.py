...
class GetSafetyEventsRequestTypedDict(TypedDict):
    start_time: str
...
class GetSafetyEventsRequest(BaseModel):
...
GetSafetyEventsResponseTypedDict = TypeAliasType(
    "GetSafetyEventsResponseTypedDict",
    Union[SafetyEventsListResponseTypedDict, StandardErrorResponseTypedDict],
)


GetSafetyEventsResponse = TypeAliasType(
    "GetSafetyEventsResponse", Union[SafetyEventsListResponse, StandardErrorResponse]
)

...
class GetTrailerStatsHistoryRequestTypedDict(TypedDict):
    start_time: str
    ...
    types: str
    r"""The stat types you want this endpoint to return information on.
    ...
    * `reeferDoorStateZone3`: The door status in zone 3 of the reefer. Only supported on multizone reefer solutions.
    ...
    trailer_ids: NotRequired[str]
    r"""A filter on the data based on this comma-separated list of trailer IDs and externalIds. Example: `trailerIds=1234,5678,samsara.vin:1HGBH41JXMN109186`"""
    decorations: NotRequired[str]
    r"""Decorations add to the primary stats listed in the `types` parameter. For example, if you wish to know the trailer's location whenever the odometer updates, you may set `types=gpsOdometerMeters&decorations=gps`.
...
class GetTrailerStatsHistoryRequest(BaseModel):
    ...
    * `reeferDoorStateZone3`: The door status in zone 3 of the reefer. Only supported on multizone reefer solutions.
    ...
    trailer_ids: Annotated[
        Optional[str],
        pydantic.Field(alias="trailerIds"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""A filter on the data based on this comma-separated list of trailer IDs and externalIds. Example: `trailerIds=1234,5678,samsara.vin:1HGBH41JXMN109186`"""
...
GetTrailerStatsHistoryResponseTypedDict = TypeAliasType(
...
GetTrailerStatsHistoryResponse = TypeAliasType(

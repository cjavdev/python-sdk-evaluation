...
class TrailerStatReeferSetPointTemperatureMilliCZone2WithDecorationsTypeResponseBodyTypedDict(
    TypedDict
):
...
class TrailerStatReeferSetPointTemperatureMilliCZone2WithDecorationsTypeResponseBody(
    BaseModel
):
    r"""Set point temperature of zone 2 of the reefer."""

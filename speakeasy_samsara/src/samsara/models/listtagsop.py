...
ListTagsResponse1TypedDict = TypeAliasType(
    "ListTagsResponse1TypedDict",
    Union[ListTagsResponseTypedDict, StandardErrorResponseTypedDict],
)


ListTagsResponse1 = TypeAliasType(
    "ListTagsResponse1", Union[ListTagsResponse, StandardErrorResponse]
)

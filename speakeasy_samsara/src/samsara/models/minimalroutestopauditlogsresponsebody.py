...
class MinimalRouteStopAuditLogsResponseBodyState(str, Enum):
...
class MinimalRouteStopAuditLogsResponseBodyTypedDict(TypedDict):
    ...
    r"""Scheduled arrival time, if it exists, for the stop in RFC 3339 format. If it does not exist, and this field was changed in the update, it will be an empty string."""
    scheduled_departure_time: NotRequired[datetime]
    r"""Scheduled departure time, if it exists, for the stop in RFC 3339 format. If it does not exist, and this field was changed in the update, it will be an empty string."""
    skipped_time: NotRequired[datetime]
    r"""Skipped time, if it exists, for the route stop in RFC 3339 format."""
    state: NotRequired[MinimalRouteStopAuditLogsResponseBodyState]
    r"""The current state of the route stop.  Valid values: `unassigned`, `scheduled`, `en route`, `skipped`, `arrived`, `departed`"""


class MinimalRouteStopAuditLogsResponseBody(BaseModel):
    r"""A single route stop for a route."""
    ...
    state: Optional[MinimalRouteStopAuditLogsResponseBodyState] = None
    r"""The current state of the route stop.  Valid values: `unassigned`, `scheduled`, `en route`, `skipped`, `arrived`, `departed`"""

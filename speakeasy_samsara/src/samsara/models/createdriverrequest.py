...
class CreateDriverRequestTypedDict(TypedDict):
    r"""Driver that should be created."""
    ...
    hos_setting: NotRequired[DriverHosSettingTypedDict]
    ...
    r"""The peer group tag id this driver belong to, used for gamification."""
...
class CreateDriverRequest(BaseModel):
    ...
    hos_setting: Annotated[
        Optional[DriverHosSetting], pydantic.Field(alias="hosSetting")
    ] = None
    r"""Hos settings for a driver."""

...
class TrailerStatReeferSupplyAirTemperatureMilliCZone3TypeResponseBodyTypedDict(
    TypedDict
):
...
class TrailerStatReeferSupplyAirTemperatureMilliCZone3TypeResponseBody(BaseModel):
    r"""Supply or discharge air temperature of zone 2 of the reefer. This is the temperature of the air as it leaves the cooling unit."""

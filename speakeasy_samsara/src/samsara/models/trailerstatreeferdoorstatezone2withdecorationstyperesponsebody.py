...
class TrailerStatReeferDoorStateZone2WithDecorationsTypeResponseBodyValue(str, Enum):
...
class TrailerStatReeferDoorStateZone2WithDecorationsTypeResponseBodyTypedDict(
    TypedDict
):
    ...
    value: TrailerStatReeferDoorStateZone2WithDecorationsTypeResponseBodyValue
    r"""The door state of zone 2 of the reefer.  Valid values: `open`, `closed`"""
...
class TrailerStatReeferDoorStateZone2WithDecorationsTypeResponseBody(BaseModel):
    r"""Door stats that have been emitted by the reefer."""

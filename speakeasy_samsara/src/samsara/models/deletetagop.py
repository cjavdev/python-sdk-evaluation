...
DeleteTagResponseTypedDict = TypeAliasType(
    "DeleteTagResponseTypedDict", Union[StandardErrorResponseTypedDict, str]
)


DeleteTagResponse = TypeAliasType(
    "DeleteTagResponse", Union[StandardErrorResponse, str]
)

...
class TrailerStatReeferDoorStateZone3WithDecorationsTypeResponseBodyValue(str, Enum):
...
class TrailerStatReeferDoorStateZone3WithDecorationsTypeResponseBodyTypedDict(
    TypedDict
):
    ...
    value: TrailerStatReeferDoorStateZone3WithDecorationsTypeResponseBodyValue
    r"""The door state of zone 2 of the reefer.  Valid values: `open`, `closed`"""
...
class TrailerStatReeferDoorStateZone3WithDecorationsTypeResponseBody(BaseModel):
    r"""Door stats that have been emitted by the reefer."""

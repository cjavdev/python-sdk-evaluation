...
class TrailerStatReeferReturnAirTemperatureMilliCZone1WithDecorationsTypeResponseBodyTypedDict(
    TypedDict
):
...
class TrailerStatReeferReturnAirTemperatureMilliCZone1WithDecorationsTypeResponseBody(
    BaseModel
):
    r"""Return air temperature of zone 1 of the reefer. This is the temperature of the air as it enters the cooling unit."""

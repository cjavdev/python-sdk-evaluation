...
class HarshEventTriggerDetailsObjectRequestBodyTypedDict(TypedDict):
    r"""Details specific to Harsh Events"""

    types: List[HarshEventTriggerDetailsObjectRequestBodyTypes]
    r"""On which harsh events to trigger on."""


class HarshEventTriggerDetailsObjectRequestBody(BaseModel):
    r"""Details specific to Harsh Events"""

...
class GetVehicleTachographFilesRequestTypedDict(TypedDict):
    start_time: str
...
class GetVehicleTachographFilesRequest(BaseModel):
...
GetVehicleTachographFilesResponseTypedDict = TypeAliasType(
    "GetVehicleTachographFilesResponseTypedDict",
    Union[TachographVehicleFilesResponseTypedDict, StandardErrorResponseTypedDict],
)


GetVehicleTachographFilesResponse = TypeAliasType(
    "GetVehicleTachographFilesResponse",
    Union[TachographVehicleFilesResponse, StandardErrorResponse],
)

...
class TrailerStatReeferStateZone3WithDecorationsTypeResponseBodyTypedDict(TypedDict):
...
class TrailerStatReeferStateZone3WithDecorationsTypeResponseBody(BaseModel):
    r"""Reefer state event."""

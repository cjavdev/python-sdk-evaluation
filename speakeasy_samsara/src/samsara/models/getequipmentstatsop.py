...
class QueryParamTypes(str, Enum):
...
class GetEquipmentStatsRequestTypedDict(TypedDict):
    types: List[QueryParamTypes]
...
class GetEquipmentStatsRequest(BaseModel):
    types: Annotated[
        List[QueryParamTypes],
...
GetEquipmentStatsResponseTypedDict = TypeAliasType(
    "GetEquipmentStatsResponseTypedDict",
    Union[EquipmentStatsResponseTypedDict, StandardErrorResponseTypedDict],
)


GetEquipmentStatsResponse = TypeAliasType(
    "GetEquipmentStatsResponse", Union[EquipmentStatsResponse, StandardErrorResponse]
)

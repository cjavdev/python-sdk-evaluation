...
class WorkflowTriggerObjectRequestBodyTypedDict(TypedDict):
    ...
    """
    trigger_params: NotRequired[TriggerParamsObjectRequestBodyTypedDict]
    r"""The trigger type specific details. Only the field that corresponds to the trigger type is filled in."""


class WorkflowTriggerObjectRequestBody(BaseModel):
    r"""The trigger of an alert."""
    ...
    trigger_params: Annotated[
        Optional[TriggerParamsObjectRequestBody], pydantic.Field(alias="triggerParams")
    ] = None
    r"""The trigger type specific details. Only the field that corresponds to the trigger type is filled in."""

...
class VehicleStats(BaseSDK):
    def get_vehicle_stats(
        self,
        *,
        types: List[models.GetVehicleStatsQueryParamTypes],
    ...
    ) -> models.GetVehicleStatsResponse:
        r"""Stats snapshot
        ...
        **Submit Feedback**: Likes, dislikes, and API feature requests should be filed as feedback in our <a href=\"https://forms.gle/zkD4NCH7HjKb7mm69\" target=\"_blank\">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href=\"https://www.samsara.com/help\" target=\"_blank\">submit a case</a> to our support team.
        ...
        :param time: A filter on the data that returns the last known data points with timestamps less than or equal to this value. Defaults to now if not provided. Must be a string in RFC 3339 format. Millisecond precision and timezones are supported. (Example: `2020-01-27T07:06:25Z`).
        ...
        request = models.GetVehicleStatsRequest(
            after=after,
            time=time,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.VehicleStatsResponse)
    ...
    async def get_vehicle_stats_async(
        self,
        *,
        types: List[models.GetVehicleStatsQueryParamTypes],
        after: Optional[str] = None,
    ...
    def get_vehicle_stats_feed(
        self,
        *,
        types: List[models.GetVehicleStatsFeedQueryParamTypes],
        after: Optional[str] = None,
        parent_tag_ids: Optional[List[str]] = None,
        tag_ids: Optional[List[str]] = None,
        vehicle_ids: Optional[List[str]] = None,
        decorations: Optional[List[models.Decorations]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.GetVehicleStatsFeedResponse:
        r"""Stats feed
        ...
        **Submit Feedback**: Likes, dislikes, and API feature requests should be filed as feedback in our <a href=\"https://forms.gle/zkD4NCH7HjKb7mm69\" target=\"_blank\">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href=\"https://www.samsara.com/help\" target=\"_blank\">submit a case</a> to our support team.
        ...
        request = models.GetVehicleStatsFeedRequest(
            after=after,
            parent_tag_ids=parent_tag_ids,
            tag_ids=tag_ids,
            vehicle_ids=vehicle_ids,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                base_url=base_url or "",
                operation_id="getVehicleStatsFeed",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.VehicleStatsListResponse)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError(
                "API error occurred", http_res.status_code, http_res_text, http_res
    ...
    async def get_vehicle_stats_feed_async(
        self,
        *,
        types: List[models.GetVehicleStatsFeedQueryParamTypes],
        after: Optional[str] = None,
    ...
    def get_vehicle_stats_history(
        ...
        *,
        start_time: str,
        end_time: str,
        types: List[models.GetVehicleStatsHistoryQueryParamTypes],
        after: Optional[str] = None,
        parent_tag_ids: Optional[List[str]] = None,
        tag_ids: Optional[List[str]] = None,
        vehicle_ids: Optional[List[str]] = None,
        decorations: Optional[List[models.QueryParamDecorations]] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.GetVehicleStatsHistoryResponse:
        r"""Historical stats
        ...
        **Submit Feedback**: Likes, dislikes, and API feature requests should be filed as feedback in our <a href=\"https://forms.gle/zkD4NCH7HjKb7mm69\" target=\"_blank\">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href=\"https://www.samsara.com/help\" target=\"_blank\">submit a case</a> to our support team.
        ...
        request = models.GetVehicleStatsHistoryRequest(
            after=after,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                base_url=base_url or "",
                operation_id="getVehicleStatsHistory",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    async def get_vehicle_stats_history_async(
        self,
        *,
        start_time: str,
        end_time: str,

...
class VehicleLocations(BaseSDK):
    def get_vehicle_locations(
    ...
    ) -> models.GetVehicleLocationsResponse:
        r"""Locations snapshot
        ...
        **Submit Feedback**: Likes, dislikes, and API feature requests should be filed as feedback in our <a href=\"https://forms.gle/zkD4NCH7HjKb7mm69\" target=\"_blank\">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href=\"https://www.samsara.com/help\" target=\"_blank\">submit a case</a> to our support team.
        ...
        request = models.GetVehicleLocationsRequest(
            after=after,
            time=time,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.VehicleLocationsResponse)
    ...
    async def get_vehicle_locations_async(
        self,
        *,
        after: Optional[str] = None,
        time: Optional[str] = None,
    ...
    def get_vehicle_locations_feed(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.GetVehicleLocationsFeedResponse:
        r"""Locations feed
        ...
        **Submit Feedback**: Likes, dislikes, and API feature requests should be filed as feedback in our <a href=\"https://forms.gle/zkD4NCH7HjKb7mm69\" target=\"_blank\">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href=\"https://www.samsara.com/help\" target=\"_blank\">submit a case</a> to our support team.
        ...
        request = models.GetVehicleLocationsFeedRequest(
            after=after,
            parent_tag_ids=parent_tag_ids,
            tag_ids=tag_ids,
            vehicle_ids=vehicle_ids,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                base_url=base_url or "",
                operation_id="getVehicleLocationsFeed",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.VehicleLocationsListResponse
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError(
    ...
    async def get_vehicle_locations_feed_async(
        self,
        *,
        after: Optional[str] = None,
        parent_tag_ids: Optional[List[str]] = None,
    ...
    def get_vehicle_locations_history(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.GetVehicleLocationsHistoryResponse:
        r"""Historical locations
        ...
        **Submit Feedback**: Likes, dislikes, and API feature requests should be filed as feedback in our <a href=\"https://forms.gle/zkD4NCH7HjKb7mm69\" target=\"_blank\">API feedback form</a>. If you encountered an issue or noticed inaccuracies in the API documentation, please <a href=\"https://www.samsara.com/help\" target=\"_blank\">submit a case</a> to our support team.
        ...
        request = models.GetVehicleLocationsHistoryRequest(
            after=after,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                base_url=base_url or "",
                operation_id="getVehicleLocationsHistory",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    async def get_vehicle_locations_history_async(
        self,
        *,
        start_time: str,
        end_time: str,

...
DeleteUserResponseTypedDict = TypeAliasType(
    "DeleteUserResponseTypedDict", Union[StandardErrorResponseTypedDict, str]
)


DeleteUserResponse = TypeAliasType(
    "DeleteUserResponse", Union[StandardErrorResponse, str]
)

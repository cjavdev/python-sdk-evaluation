...
class WebhooksPostWebhooksResponseBodyEventTypes(str, Enum):
...
class WebhooksPostWebhooksResponseBodyVersion(str, Enum):
...
class WebhooksPostWebhooksResponseBodyTypedDict(TypedDict):
    id: str
    ...
    version: WebhooksPostWebhooksResponseBodyVersion
    r"""The version of the webhook.  Valid values: `2018-01-01`, `2021-06-09`"""
    ...
    event_types: NotRequired[List[WebhooksPostWebhooksResponseBodyEventTypes]]
    r"""The list of event types associated with a particular webhook."""


class WebhooksPostWebhooksResponseBody(BaseModel):
    id: str
    r"""The ID of the webhook. This will appear in both Samsara’s cloud dashboard and the API. This is the id of the webhook. This is system generated."""
    ...
    event_types: Annotated[
        Optional[List[WebhooksPostWebhooksResponseBodyEventTypes]],

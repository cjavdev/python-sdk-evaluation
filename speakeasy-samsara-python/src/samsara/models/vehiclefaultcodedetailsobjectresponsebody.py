...
class VehicleFaultCodeDetailsObjectResponseBodyTypedDict(TypedDict):
    ...
    specific_fault_codes: NotRequired[
        List[SpecificVehicleFaultCodeObjectResponseBodyTypedDict]
    ]
    r"""The list of specific fault codes to be alerted on."""


class VehicleFaultCodeDetailsObjectResponseBody(BaseModel):
    r"""Details specific to Vehicle Fault Code. At least one fault code or fault code group must be selected."""
    ...
    specific_fault_codes: Annotated[
        Optional[List[SpecificVehicleFaultCodeObjectResponseBody]],

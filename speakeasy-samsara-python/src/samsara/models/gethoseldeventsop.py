...
class QueryParamDriverActivationStatus(str, Enum):
...
class GetHosEldEventsRequestTypedDict(TypedDict):
    start_time: str
    ...
    driver_activation_status: NotRequired[QueryParamDriverActivationStatus]
    r"""If value is `deactivated`, only drivers that are deactivated will appear in the response. This parameter will default to `active` if not provided (fetching only active drivers).  Valid values: `active`, `deactivated`"""
    ...
    r"""The limit for how many objects will be in the response. Default and max for this value is 25 objects."""


class GetHosEldEventsRequest(BaseModel):
    ...
    driver_activation_status: Annotated[
        Optional[QueryParamDriverActivationStatus],
        pydantic.Field(alias="driverActivationStatus"),
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = QueryParamDriverActivationStatus.ACTIVE
    r"""If value is `deactivated`, only drivers that are deactivated will appear in the response. This parameter will default to `active` if not provided (fetching only active drivers).  Valid values: `active`, `deactivated`"""
...
GetHosEldEventsResponseTypedDict = TypeAliasType(
...
GetHosEldEventsResponse = TypeAliasType(

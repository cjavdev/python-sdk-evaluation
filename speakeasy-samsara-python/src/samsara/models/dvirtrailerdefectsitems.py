...
class DvirTrailerDefectsItemsTrailerTypedDict(TypedDict):
...
class DvirTrailerDefectsItemsTrailer(BaseModel):
    r"""A minified trailer object."""
...
class DvirTrailerDefectsItemsVehicleTypedDict(TypedDict):
...
class DvirTrailerDefectsItemsVehicle(BaseModel):
    r"""A minified vehicle object."""
...
class DvirTrailerDefectsItemsTypedDict(TypedDict):
    id: str
    r"""ID of the defect."""
    is_resolved: bool
    ...
    trailer: NotRequired[DvirTrailerDefectsItemsTrailerTypedDict]
    vehicle: NotRequired[DvirTrailerDefectsItemsVehicleTypedDict]


class DvirTrailerDefectsItems(BaseModel):
    id: str
    r"""ID of the defect."""
    ...
    trailer: Optional[DvirTrailerDefectsItemsTrailer] = None

    vehicle: Optional[DvirTrailerDefectsItemsVehicle] = None

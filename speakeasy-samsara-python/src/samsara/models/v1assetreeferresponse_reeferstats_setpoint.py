...
class V1AssetReeferResponseReeferStatsSetPointTypedDict(TypedDict):
    changed_at_ms: NotRequired[int]
    r"""Timestamp in Unix milliseconds since epoch."""
    temp_in_milli_c: NotRequired[int]
    r"""Set point temperature in millidegree Celsius."""


class V1AssetReeferResponseReeferStatsSetPoint(BaseModel):

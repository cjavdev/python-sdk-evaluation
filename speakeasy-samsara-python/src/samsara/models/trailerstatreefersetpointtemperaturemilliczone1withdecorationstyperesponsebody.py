...
class TrailerStatReeferSetPointTemperatureMilliCZone1WithDecorationsTypeResponseBodyTypedDict(
    TypedDict
):
...
class TrailerStatReeferSetPointTemperatureMilliCZone1WithDecorationsTypeResponseBody(
    BaseModel
):
    r"""Set point temperature of zone 1 of the reefer."""

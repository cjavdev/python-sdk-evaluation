...
class TrailerStatReeferStateZone2WithDecorationsTypeResponseBodyTypedDict(TypedDict):
    r"""Reefer state event."""

    time: str
    r"""UTC timestamp in RFC 3339 format."""
    value: str
    r"""The state zone 2 of the reefer."""
    ...
    r"""The substate zone 2 of the reefer, if available."""


class TrailerStatReeferStateZone2WithDecorationsTypeResponseBody(BaseModel):
    r"""Reefer state event."""

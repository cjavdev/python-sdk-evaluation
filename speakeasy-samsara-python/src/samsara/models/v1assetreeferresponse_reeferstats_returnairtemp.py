...
class V1AssetReeferResponseReeferStatsReturnAirTempTypedDict(TypedDict):
    changed_at_ms: NotRequired[int]
    r"""Timestamp in Unix milliseconds since epoch."""
    temp_in_milli_c: NotRequired[int]
    r"""Return air temperature in millidegree Celsius."""


class V1AssetReeferResponseReeferStatsReturnAirTemp(BaseModel):

...
class GetIndustrialAssetsRequestTypedDict(TypedDict):
...
class GetIndustrialAssetsRequest(BaseModel):
    limit: Annotated[
        Optional[int],
...
GetIndustrialAssetsResponseTypedDict = TypeAliasType(
    "GetIndustrialAssetsResponseTypedDict",
    Union[ListIndustrialAssetsResponseTypedDict, StandardErrorResponseTypedDict],
)


GetIndustrialAssetsResponse = TypeAliasType(
    "GetIndustrialAssetsResponse",
    Union[ListIndustrialAssetsResponse, StandardErrorResponse],
)

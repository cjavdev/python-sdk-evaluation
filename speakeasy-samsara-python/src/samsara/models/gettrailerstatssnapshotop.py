...
class GetTrailerStatsSnapshotRequestTypedDict(TypedDict):
    types: str
    ...
    * `reeferDoorStateZone3`: The door status in zone 3 of the reefer. Only supported on multizone reefer solutions.
    ...
    r"""A filter on the data that returns the last known data points with timestamps less than or equal to this value. Defaults to now if not provided. Must be a string in RFC 3339 Format. Millisecond precision and timezones are supported."""


class GetTrailerStatsSnapshotRequest(BaseModel):
    types: Annotated[
...
GetTrailerStatsSnapshotResponseTypedDict = TypeAliasType(
...
GetTrailerStatsSnapshotResponse = TypeAliasType(

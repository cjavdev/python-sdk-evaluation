...
class DocumentTypesGetDocumentTypesBadRequestErrorResponseBodyTypedDict(TypedDict):
...
class DocumentTypesGetDocumentTypesBadRequestErrorResponseBody(BaseModel):
    r"""Bad Request parameters"""

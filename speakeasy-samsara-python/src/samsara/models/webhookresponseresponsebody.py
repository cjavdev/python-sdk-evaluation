...
class WebhookResponseResponseBodyTypedDict(TypedDict):
    r"""The response for POST/GET/PATCH a webhook"""
    ...
    event_types: NotRequired[List[EventTypes]]
    r"""The list of event types associated with a particular webhook."""


class WebhookResponseResponseBody(BaseModel):
    r"""The response for POST/GET/PATCH a webhook"""
    ...
    event_types: Annotated[
        Optional[List[EventTypes]], pydantic.Field(alias="eventTypes")
    ] = None
    r"""The list of event types associated with a particular webhook."""

...
class GetDataInputDataFeedRequestTypedDict(TypedDict):
...
class GetDataInputDataFeedRequest(BaseModel):
    after: Annotated[
        Optional[str],
...
GetDataInputDataFeedResponseTypedDict = TypeAliasType(
    "GetDataInputDataFeedResponseTypedDict",
    Union[DataInputListResponseTypedDict, StandardErrorResponseTypedDict],
)


GetDataInputDataFeedResponse = TypeAliasType(
    "GetDataInputDataFeedResponse", Union[DataInputListResponse, StandardErrorResponse]
)

...
class FuelPurchasePostFuelPurchaseBadRequestErrorResponseBodyTypedDict(TypedDict):
...
class FuelPurchasePostFuelPurchaseBadRequestErrorResponseBody(BaseModel):
    r"""Bad Request parameters"""

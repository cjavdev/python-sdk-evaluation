...
class SettingsGetComplianceSettingsBadRequestErrorResponseBodyTypedDict(TypedDict):
...
class SettingsGetComplianceSettingsBadRequestErrorResponseBody(BaseModel):
    r"""Bad Request parameters"""

...
class HosViolationsGetHosViolationsBadRequestErrorResponseBodyTypedDict(TypedDict):
...
class HosViolationsGetHosViolationsBadRequestErrorResponseBody(BaseModel):
    r"""Bad Request parameters"""

...
class AssetsUpdateAssetResponseBodyRegulationMode(str, Enum):
...
class AssetsUpdateAssetResponseBodyType(str, Enum):
...
class AssetsUpdateAssetResponseBodyTypedDict(TypedDict):
    created_at_time: str
    ...
    regulation_mode: NotRequired[AssetsUpdateAssetResponseBodyRegulationMode]
    r"""Whether or not the asset is regulated, unregulated (non-CMV), or a mixed use unregulated asset. Primarily used with vehicles.  Valid values: `mixed`, `regulated`, `unregulated`"""
    ...
    type: NotRequired[AssetsUpdateAssetResponseBodyType]
    r"""The operational context in which the asset interacts with the Samsara system. Examples: Vehicle (eg: truck, bus...), Trailer (eg: dry van, reefer, flatbed...), Powered Equipment (eg: dozer, crane...), Unpowered Equipment (eg: container, dumpster...), or Uncategorized.  Valid values: `uncategorized`, `trailer`, `equipment`, `unpowered`, `vehicle`"""
    vin: NotRequired[str]
...
class AssetsUpdateAssetResponseBody(BaseModel):
    ...
    regulation_mode: Annotated[
        Optional[AssetsUpdateAssetResponseBodyRegulationMode],
    ...
    type: Optional[AssetsUpdateAssetResponseBodyType] = (
        AssetsUpdateAssetResponseBodyType.UNCATEGORIZED
    )
    r"""The operational context in which the asset interacts with the Samsara system. Examples: Vehicle (eg: truck, bus...), Trailer (eg: dry van, reefer, flatbed...), Powered Equipment (eg: dozer, crane...), Unpowered Equipment (eg: container, dumpster...), or Uncategorized.  Valid values: `uncategorized`, `trailer`, `equipment`, `unpowered`, `vehicle`"""

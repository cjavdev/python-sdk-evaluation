...
class GetDriverEfficiencyByDriversRequestTypedDict(TypedDict):
    start_time: str
...
class GetDriverEfficiencyByDriversRequest(BaseModel):
...
GetDriverEfficiencyByDriversResponseTypedDict = TypeAliasType(
...
GetDriverEfficiencyByDriversResponse = TypeAliasType(

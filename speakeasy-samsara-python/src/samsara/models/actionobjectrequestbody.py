...
class ActionObjectRequestBodyTypedDict(TypedDict):
    r"""Action to take."""
    ...
    """
    action_params: NotRequired[ActionParamsObjectRequestBodyTypedDict]
...
class ActionObjectRequestBody(BaseModel):
    r"""Action to take."""
    ...
    action_params: Annotated[
        Optional[ActionParamsObjectRequestBody], pydantic.Field(alias="actionParams")
    ] = None
    r"""The action type specific details. Set webhookIds for Slack or Webhook actions. Set recipients for Notifications. Set driverAppNotification for Driver App Push. Other action types don't need to set a param."""

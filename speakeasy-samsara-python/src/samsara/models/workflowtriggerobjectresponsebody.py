...
class WorkflowTriggerObjectResponseBodyTypedDict(TypedDict):
    r"""The trigger of an alert."""

    trigger_type_id: int
    r"""The id of the trigger type. Reference the following list for the ids:
    ...
    """
    trigger_params: NotRequired[TriggerParamsObjectResponseBodyTypedDict]
    r"""The trigger type specific details. Only the field that corresponds to the trigger type is filled in."""


class WorkflowTriggerObjectResponseBody(BaseModel):
    r"""The trigger of an alert."""

    trigger_type_id: Annotated[int, pydantic.Field(alias="triggerTypeId")]
    r"""The id of the trigger type. Reference the following list for the ids:
    ...
    trigger_params: Annotated[
        Optional[TriggerParamsObjectResponseBody], pydantic.Field(alias="triggerParams")
    ] = None
    r"""The trigger type specific details. Only the field that corresponds to the trigger type is filled in."""

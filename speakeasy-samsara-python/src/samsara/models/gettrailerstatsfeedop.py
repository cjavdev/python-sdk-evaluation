...
class GetTrailerStatsFeedRequestTypedDict(TypedDict):
    types: str
...
class GetTrailerStatsFeedRequest(BaseModel):
    types: Annotated[
...
GetTrailerStatsFeedResponseTypedDict = TypeAliasType(
...
GetTrailerStatsFeedResponse = TypeAliasType(

...
class GetHosClocksRequestTypedDict(TypedDict):
...
class GetHosClocksRequest(BaseModel):
    tag_ids: Annotated[
        Optional[List[str]],
...
GetHosClocksResponseTypedDict = TypeAliasType(
    "GetHosClocksResponseTypedDict",
    Union[HosClocksResponseTypedDict, StandardErrorResponseTypedDict],
)


GetHosClocksResponse = TypeAliasType(
    "GetHosClocksResponse", Union[HosClocksResponse, StandardErrorResponse]
)

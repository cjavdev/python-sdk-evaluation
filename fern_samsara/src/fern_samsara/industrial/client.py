...
class IndustrialClient:
    ...
    def list(self, *, request_options: typing.Optional[RequestOptions] = None) -> V1VisionCamerasResponse:
        """
        <n class="warning">
        <nh>
    ...
    def get_vision_runs_by_camera_and_program(
        self,
        camera_id: int,
        program_id: int,
        started_at_ms: int,
...
class AsyncIndustrialClient:
    ...
    async def get_assets(
        ...
        *,
        ...
        async def main() -> None:
            await client.industrial.get_assets()
    ...
    async def create_asset(
        ...
        *,
        ...
        async def main() -> None:
            await client.industrial.create_asset(
                name="name",
            )
    ...
    async def delete_asset(
        ...
        async def main() -> None:
            await client.industrial.delete_asset(
                id="id",
            )
    ...
    async def patch_asset(
        ...
        *,
        ...
        async def main() -> None:
            await client.industrial.patch_asset(
                id="id",
            )
    ...
    async def list(self, *, request_options: typing.Optional[RequestOptions] = None) -> V1VisionCamerasResponse:
        """
        <n class="warning">
        <nh>
        <i class="fa fa-exclamation-circle"></i>
    ...
    async def list_programs(
        ...
        async def main() -> None:
            await client.industrial.list_programs(
                camera_id=1000000,
            )
    ...
    async def get_latest_run(
        ...
        *,
        ...
        async def main() -> None:
            await client.industrial.get_latest_run(
                camera_id=1000000,
            )
    ...
    async def list_runs(
        ...
        *,
        ...
        async def main() -> None:
            await client.industrial.list_runs(
                duration_ms=1000000,
            )
    ...
    async def get_vision_runs_by_camera_and_program(
        self,
        camera_id: int,
        program_id: int,
        started_at_ms: int,
        *,
        ...
        async def main() -> None:
            await client.industrial.get_vision_runs_by_camera_and_program(
                camera_id=1000000,
                program_id=1000000,
                started_at_ms=1000000,
            )
